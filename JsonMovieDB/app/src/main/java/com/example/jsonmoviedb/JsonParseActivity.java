...
public class JsonParseActivity extends AppCompatActivity{
    ...
    private String getListData() {
        String jsonStr = "{ \"user\" :[" +
                "{\"name\":\"Valen\",\"designation\":\"Leader\",\"location\":\"East Blue\"}" +
                ",{\"name\":\"Akbar\",\"designation\":\"Vice Leader\",\"location\":\"East Blue\"}" +
                ",{\"name\":\"Irfani\",\"designation\":\"Navigator\",\"location\":East Blue\"}] }";
        return jsonStr;
    }
}
